...
![PDF](https://img.shields.io/badge/Reportes-PDF-red)
...
* **Segmentación de roles:**
  ...
  * Alumnos (enfoque académico)
  * Administrativos (enfoque laboral)
...
* **Dashboard administrativo:**
  ...
  * Tablas dinámicas de resultados
...
* El usuario puede eliminar sus datos completamente
